function [P_list, s_x_list, K_ff_list, K_fb_list,  t_grid] = solve_DRE(x_ref, u_ref, A, B_list, Q, R, QN, T, dt)
...
% Minimal changes from your original backward-Euler version.
    ...
    for k = 1:N-1
        ...
        K_fb_list{k} = Rinv * Bk' * Pk;   % feedback gain
        K_ff_list{k} = Rinv * Bk' * sk;   % feedforward (minimal-change)
    end
