function path_integral_params = PI_params()

path_integral_params.dt_sim = 0.01; % sim time step
path_integral_params.t_end_unstable = 0.01;
path_integral_params.t_end = 0.01; % end time for open loop simualtion and final time of path integral
